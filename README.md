...
Update 01-11-2017 - Yes it IS possible to run KDE1 on a modern system. I have it currently running on a Debian 8 system. It's far from fully functional, as many components are not currently working. However the base part DOES run and is stable. Contact me for proof or binaries if you so wish.