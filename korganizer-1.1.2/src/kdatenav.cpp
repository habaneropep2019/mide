// 	$Id: kdatenav.cpp,v 1.41.2.3 1999/04/30 04:44:35 pbrown Exp $	
  ...
  : QFrame(parent, name)
{
  ...
  const char *months[] = {i18n("January"), i18n("February"), i18n("March"),
			  i18n("April"), i18n("May"), i18n("June"), i18n("July"),
			  i18n("August"), i18n("September"), i18n("October"),
  ...
  headingSep = new QFrame(viewFrame);
  ...
  weeknumSep = new QFrame(viewFrame);
...
{
  register int i;
  static const char *months[] = { i18n("January"), i18n("February"), 
...
{
  char sDay[2] = "*";
  const char *monHeaders[] = { i18n("Monday"), i18n("Tuesday"), 
			       i18n("Wednesday"), i18n("Thursday"),
			       i18n("Friday"), i18n("Saturday"), 
			       i18n("Sunday") };
  const char *sunHeaders[] = { i18n("Sunday"), i18n("Monday"), 
  ...
  showDailyRecurrences = config->readBoolEntry("Show Daily Recurrences", 
					       FALSE);
...
void KDateNavigator::selectDates(const QDateList dateList)
{
  ...
  for (; it.current(); ++it) {
    if (!it.current()->isValid()) {
      selectedDates.clear();
      selectedDates.append(new QDate(QDate::currentDate()));
      debug("KDateNavigator::selectDates: an invalid date was passed as a parameter!");
      emit datesSelected(selectedDates);
    }
  }
